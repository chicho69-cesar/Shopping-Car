...
namespace ShoppingCar.Migrations
{
    ...
    [Migration("20220704211749_ChangeLocationEntities")]
    partial class ChangeLocationEntities
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ShoppingCar.Data.Entities.Sale", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("ShoppingCar.Data.Entities.SaleDetail", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("ShoppingCar.Data.Entities.TemporalSale", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("ShoppingCar.Data.Entities.User", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("nvarchar(450)");
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("ShoppingCar.Data.Entities.User", null)
                        .WithMany()
            ...
            modelBuilder.Entity("ShoppingCar.Data.Entities.City", b =>
                {
                    b.HasOne("ShoppingCar.Data.Entities.State", "State")
                        .WithMany("Cities")
            ...
            modelBuilder.Entity("ShoppingCar.Data.Entities.Sale", b =>
                {
                    b.HasOne("ShoppingCar.Data.Entities.User", "User")
                        .WithMany("Sales")
                        .HasForeignKey("UserId");
            ...
            modelBuilder.Entity("ShoppingCar.Data.Entities.SaleDetail", b =>
                {
                    ...
                    b.HasOne("ShoppingCar.Data.Entities.Sale", "Sale")
                        .WithMany("SaleDetails")
            ...
            modelBuilder.Entity("ShoppingCar.Data.Entities.User", b =>
                {
                    b.HasOne("ShoppingCar.Data.Entities.City", "City")
                        .WithMany("Users")

...
namespace ShoppingCar.Data {
    public class SeedDb {
        ...
        public async Task SeedAsync() {
            ...
            await CheckUserAsync("1010", "Cesar", "Villalobos Olmos", "cesar@yopmail.com", "346 109 9207", "Av. Cananal #9", UserType.Admin);
            await CheckUserAsync("2020", "Lizeth", "Sandoval Vallejo", "liz@yopmail.com", "346 100 5286", "Centro #45", UserType.User);
        }
